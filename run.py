...
import argparse
from subgraph_alignment import subgraph_embeddings2
...
def main(args):
    ...
    attr = attr.A
    embedding, M = subgraph_embeddings2(attr, adj, args.h)
    ...
    en_scores = generate_scores(scores, M, args)
    print(
        f'dataset : {args.dataset}, auc = {roc_auc_score(label, -en_scores)}\n')
